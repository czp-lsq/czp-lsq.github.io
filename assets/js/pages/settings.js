  ...
  const renderAbout = () => {
    ...
    return React.createElement(
      ...
      React.createElement("div", { className: "settings-section" },
        ...
        React.createElement("div", { style: { marginTop: "16px", background: "linear-gradient(135deg, var(--color-primary-50) 0%, var(--color-accent-50) 50%, var(--color-success-bg) 100%)", borderRadius: "var(--radius-lg)", padding: "24px", border: "1px solid var(--color-primary-100)", boxShadow: "0 4px 16px rgba(0,0,0,0.06)" } },
          React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "20px", marginBottom: "20px" } },
            React.createElement("div", { style: { width: "64px", height: "64px", background: "linear-gradient(135deg, var(--color-primary) 0%, var(--color-accent) 100%)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "26px", fontWeight: 700, color: "white", boxShadow: "0 4px 12px var(--color-primary-100)", flexShrink: 0 } }, "LSQ"),
            React.createElement("div", { style: { flex: 1 } },
              React.createElement("div", { style: { fontSize: "20px", fontWeight: 700, color: "var(--color-text-primary)", marginBottom: "4px", display: "flex", alignItems: "center", gap: "8px" } }, "刘思琦", React.createElement("span", { style: { fontSize: "11px", padding: "2px 8px", background: "var(--color-primary)", color: "white", borderRadius: "var(--radius-full)", fontWeight: 500 } }, "核心支持者")),
              React.createElement("div", { style: { fontSize: "13px", color: "var(--color-text-secondary)" } }, "资金赞助 · 情感后盾 · 灵感缪斯 · 产品体验官"),
            ),
          ),
          React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px", marginTop: "16px" } },
            React.createElement("div", { style: { background: "rgba(255,255,255,0.85)", borderRadius: "var(--radius-md)", padding: "14px 10px", textAlign: "center", transition: "transform 0.2s" } },
              React.createElement("div", { style: { fontSize: "22px", marginBottom: "6px" } }, "💰"),
              React.createElement("div", { style: { fontSize: "12px", fontWeight: 600, color: "var(--color-text-primary)" } }, "资金赞助"),
              React.createElement("div", { style: { fontSize: "10px", color: "var(--color-text-tertiary)", marginTop: "3px", lineHeight: "1.4" } }, "保障开发资源持续投入"),
            ),
            React.createElement("div", { style: { background: "rgba(255,255,255,0.85)", borderRadius: "var(--radius-md)", padding: "14px 10px", textAlign: "center" } },
              React.createElement("div", { style: { fontSize: "22px", marginBottom: "6px" } }, "💝"),
              React.createElement("div", { style: { fontSize: "12px", fontWeight: 600, color: "var(--color-text-primary)" } }, "情感后盾"),
              React.createElement("div", { style: { fontSize: "10px", color: "var(--color-text-tertiary)", marginTop: "3px", lineHeight: "1.4" } }, "在低谷时给予温暖力量"),
            ),
            React.createElement("div", { style: { background: "rgba(255,255,255,0.85)", borderRadius: "var(--radius-md)", padding: "14px 10px", textAlign: "center" } },
              React.createElement("div", { style: { fontSize: "22px", marginBottom: "6px" } }, "✨"),
              React.createElement("div", { style: { fontSize: "12px", fontWeight: 600, color: "var(--color-text-primary)" } }, "灵感缪斯"),
              React.createElement("div", { style: { fontSize: "10px", color: "var(--color-text-tertiary)", marginTop: "3px", lineHeight: "1.4" } }, "启发核心功能设计方向"),
            ),
            React.createElement("div", { style: { background: "rgba(255,255,255,0.85)", borderRadius: "var(--radius-md)", padding: "14px 10px", textAlign: "center" } },
              React.createElement("div", { style: { fontSize: "22px", marginBottom: "6px" } }, "🎯"),
              React.createElement("div", { style: { fontSize: "12px", fontWeight: 600, color: "var(--color-text-primary)" } }, "体验官"),
              React.createElement("div", { style: { fontSize: "10px", color: "var(--color-text-tertiary)", marginTop: "3px", lineHeight: "1.4" } }, "以用户视角驱动迭代"),
            ),
          ),
          React.createElement("div", { style: { marginTop: "16px", padding: "16px", background: "rgba(255,255,255,0.7)", borderRadius: "var(--radius-md)", fontSize: "13px", lineHeight: "1.8", color: "var(--color-text-primary)", borderLeft: "3px solid var(--color-primary)" } },
