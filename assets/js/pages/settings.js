...
const SettingsPage = ({ state, onNavigate, currentTheme, colorTheme, onChangeTheme, onChangeColorTheme, currentUser, onLogout }) => {
  ...
  const colorThemes = [
    { id: "business", name: "深邃商务", desc: "专业稳重", gradient: "linear-gradient(135deg, #1E3A5F 0%, #2D5A8F 100%)" },
    { id: "tech", name: "清新科技", desc: "现代科技感", gradient: "linear-gradient(135deg, #0D9488 0%, #0EA5E9 100%)" },
    { id: "warm", name: "温暖活力", desc: "活力亲和", gradient: "linear-gradient(135deg, #EA580C 0%, #E11D48 100%)" },
    { id: "elegant", name: "优雅紫调", desc: "精致优雅", gradient: "linear-gradient(135deg, #7C3AED 0%, #DB2777 100%)" },
  ];
  ...
  const renderAppearance = () => React.createElement(
    ...
    React.createElement("div", { className: "settings-section" },
      ...
      React.createElement("div", { className: "theme-selector theme-color-selector" },
        colorThemes.map((t) => React.createElement(
          ...
          React.createElement("div", { className: "theme-card-body" },
            React.createElement("div", { className: "theme-card-name" }, t.name),
            React.createElement("div", { className: "theme-card-desc" }, t.desc),
          ),
          colorTheme === t.id && React.createElement("div", { className: "theme-card-check" },
    ...
    React.createElement("div", { className: "settings-section" },
      ...
      React.createElement("div", { className: "theme-mode-toggle" },
        React.createElement("div", { className: "theme-mode-option" },
          React.createElement("div", { className: "theme-mode-info" },
            React.createElement("div", { className: "theme-mode-icon" },
              currentTheme === "light" ? React.createElement(Icons.Sun, null) : React.createElement(Icons.Moon, null),
            ),
            React.createElement("div", null,
              React.createElement("div", { className: "theme-mode-name" }, currentTheme === "light" ? "浅色模式" : "深色模式"),
              React.createElement("div", { className: "theme-mode-desc" }, currentTheme === "light" ? "明亮清爽" : "护眼舒适"),
            ),
          ),
          React.createElement("div", {
            className: `switch ${currentTheme === "dark" ? "active" : ""}`,
            onClick: () => onChangeTheme(currentTheme === "light" ? "dark" : "light"),
          },
            React.createElement("div", { className: "switch-handle" }),
          ),
        ),
      ),
    ),
  ...
  const renderAppSettings = () => React.createElement(
    ...
    React.createElement("div", { className: "settings-section" },
      React.createElement("div", { className: "settings-section-title" }, "基础设置"),
      Toggle({
    ...
    React.createElement("div", { className: "settings-section" },
      React.createElement("div", { className: "settings-section-title" }, "界面偏好"),
      Toggle({
      ...
      React.createElement("div", { className: "grid-2", style: { marginTop: "16px" } },
        React.createElement("div", { className: "form-item" },
          React.createElement("label", { className: "form-label" }, "默认平台"),
          React.createElement("select", {
            className: "select",
            value: appSettings.defaultPlatform,
            onChange: (e) => setAppSettings({ ...appSettings, defaultPlatform: e.target.value }),
          },
            [{ value: "pdd", label: "拼多多" }, { value: "taobao", label: "淘宝" }, { value: "douyin", label: "抖音" }].map((opt) =>
              React.createElement("option", { key: opt.value, value: opt.value }, opt.label),
            ),
          ),
        ),
        React.createElement("div", { className: "form-item" },
          React.createElement("label", { className: "form-label" }, "每页显示条数"),
          React.createElement("select", {
            className: "select",
            value: String(appSettings.pageSize),
            onChange: (e) => setAppSettings({ ...appSettings, pageSize: parseInt(e.target.value) }),
          },
            [{ value: "10", label: "10 条/页" }, { value: "20", label: "20 条/页" }, { value: "50", label: "50 条/页" }, { value: "100", label: "100 条/页" }].map((opt) =>
              React.createElement("option", { key: opt.value, value: opt.value }, opt.label),
            ),
          ),
        ),
      ),
      React.createElement("div", { className: "form-item", style: { marginTop: "16px", maxWidth: "240px" } },
        React.createElement("label", { className: "form-label" }, "语言"),
        React.createElement("select", {
          className: "select",
    ...
    React.createElement("div", { className: "settings-section" },
      React.createElement("div", { className: "settings-section-title" }, "高级操作"),
      React.createElement("div", { className: "settings-section-desc" }, "管理系统配置"),
      React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: "12px" } },
        React.createElement("div", null,
  ...
  const renderNotification = () => React.createElement(
    ...
    React.createElement("div", { className: "settings-section" },
      React.createElement("div", { className: "settings-section-title" }, "通用设置"),
      Toggle({
    ...
    React.createElement("div", { className: `settings-section ${notificationSettings.masterEnabled === false ? "settings-disabled" : ""}` },
      React.createElement("div", { className: "settings-section-title" }, "操作通知"),
      Toggle({
    ...
    React.createElement("div", { className: `settings-section ${notificationSettings.masterEnabled === false ? "settings-disabled" : ""}` },
      React.createElement("div", { className: "settings-section-title" }, "系统通知"),
      Toggle({
    ...
    return React.createElement(
      ...
      React.createElement("div", { className: "settings-section" },
        React.createElement("div", { className: "about-info" },
          ...
          React.createElement("div", { className: "about-version" }, `版本 ${window.AppVersion || "czp-1.12.0"}`),
        ...
        React.createElement("div", { className: "about-grid" },
          ...
          React.createElement("div", { className: "about-item" },
            ...
            React.createElement("div", { className: "about-item-value" }, `${window.AppVersion || "czp-1.12.0"}`),
          ),
          React.createElement("div", { className: "about-item" },
            React.createElement("div", { className: "about-item-label" }, "技术支持"),
            React.createElement("div", { className: "about-item-value" }, React.createElement("span", { style: { color: "var(--color-primary)", fontWeight: 600 } }, "czp.31")),
          ),
          React.createElement("div", { className: "about-item" },
            React.createElement("div", { className: "about-item-label" }, "测试支持"),
            React.createElement("div", { className: "about-item-value" }, React.createElement("span", { style: { color: "var(--color-success)", fontWeight: 600 } }, "lsq.811")),
          ),
        ),
      ),
      React.createElement("div", { className: "settings-section" },
        React.createElement("div", { className: "settings-section-title" }, "特别致谢"),
        React.createElement("div", { className: "settings-section-desc" }, "致敬那些让系统成为可能的伙伴"),
        React.createElement("div", { style: { marginTop: "20px", background: "#1a2332", borderRadius: "var(--radius-xl)", padding: "36px", boxShadow: "0 8px 32px rgba(26,35,50,0.35)", position: "relative", overflow: "hidden", border: "1px solid #2a3a4f" } },
          React.createElement("div", { style: { position: "relative", zIndex: 1 } },
            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "24px", marginBottom: "28px" } },
              React.createElement("div", { style: { width: "72px", height: "72px", background: "linear-gradient(135deg, #c9a96e 0%, #e8d5a3 100%)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "13px", fontWeight: 700, color: "#1a2332", flexShrink: 0, letterSpacing: "1px" } }, "LSQ"),
              React.createElement("div", { style: { flex: 1 } },
                React.createElement("div", { style: { fontSize: "28px", fontWeight: 700, color: "#f0f4f8", marginBottom: "4px", letterSpacing: "1px", fontFamily: "system-ui" } }, "刘思琦"),
                React.createElement("div", { style: { fontSize: "12px", color: "#c9a96e", fontWeight: 600, letterSpacing: "2px", textTransform: "uppercase" } }, "核心支持者 · 灵魂伙伴"),
              ),
            ),
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px", marginBottom: "28px" } },
              React.createElement("div", { style: { background: "#243044", borderRadius: "var(--radius-md)", padding: "16px 10px", textAlign: "center", border: "1px solid #2a3a4f" } },
                React.createElement("div", { style: { fontSize: "20px", marginBottom: "6px" } }, "💰"),
                React.createElement("div", { style: { fontSize: "12px", fontWeight: 700, color: "#e8d5a3", letterSpacing: "1px" } }, "资金赞助"),
                React.createElement("div", { style: { fontSize: "11px", color: "#8a9bb0", marginTop: "4px", lineHeight: "1.5" } }, "保障开发资源持续投入"),
              ),
              React.createElement("div", { style: { background: "#243044", borderRadius: "var(--radius-md)", padding: "16px 10px", textAlign: "center", border: "1px solid #2a3a4f" } },
                React.createElement("div", { style: { fontSize: "20px", marginBottom: "6px" } }, "💝"),
                React.createElement("div", { style: { fontSize: "12px", fontWeight: 700, color: "#e8d5a3", letterSpacing: "1px" } }, "情感后盾"),
                React.createElement("div", { style: { fontSize: "11px", color: "#8a9bb0", marginTop: "4px", lineHeight: "1.5" } }, "在低谷时给予温暖力量"),
              ),
              React.createElement("div", { style: { background: "#243044", borderRadius: "var(--radius-md)", padding: "16px 10px", textAlign: "center", border: "1px solid #2a3a4f" } },
                React.createElement("div", { style: { fontSize: "20px", marginBottom: "6px" } }, "✨"),
                React.createElement("div", { style: { fontSize: "12px", fontWeight: 700, color: "#e8d5a3", letterSpacing: "1px" } }, "灵感缪斯"),
                React.createElement("div", { style: { fontSize: "11px", color: "#8a9bb0", marginTop: "4px", lineHeight: "1.5" } }, "启发核心功能设计方向"),
              ),
              React.createElement("div", { style: { background: "#243044", borderRadius: "var(--radius-md)", padding: "16px 10px", textAlign: "center", border: "1px solid #2a3a4f" } },
                React.createElement("div", { style: { fontSize: "20px", marginBottom: "6px" } }, "🎯"),
                React.createElement("div", { style: { fontSize: "12px", fontWeight: 700, color: "#e8d5a3", letterSpacing: "1px" } }, "体验官"),
                React.createElement("div", { style: { fontSize: "11px", color: "#8a9bb0", marginTop: "4px", lineHeight: "1.5" } }, "以用户视角驱动迭代"),
              ),
            ),
            React.createElement("div", { style: { padding: "24px", background: "#243044", borderRadius: "var(--radius-lg)", borderLeft: "3px solid #c9a96e" } },
              React.createElement("div", { style: { fontSize: "11px", fontWeight: 700, color: "#c9a96e", marginBottom: "14px", letterSpacing: "3px", textTransform: "uppercase" } }, "致 谢 词"),
              React.createElement("div", { style: { fontSize: "14px", lineHeight: "2.0", color: "#d0d8e0", fontWeight: 400 } },
                React.createElement("span", { style: { fontSize: "18px", fontWeight: 700, color: "#e8d5a3" } }, "「"),
                "刘思琦女士，是店数智平台得以诞生的第一推动力。",
                React.createElement("br", null),
                "她用远见卓识铺就了技术探索的基石，让每一次代码迭代都无后顾之忧；她用温柔而坚韧的情感力量，在无数个困顿时刻，成为开发者最温暖的避风港。",
                React.createElement("br", null),
                React.createElement("br", null),
                "她的智慧如灯塔，穿透了深夜代码迷宫中的层层迷雾——从最初的灵光一现，到产品架构的反复推敲，再到每一次功能的细致打磨，她的洞察始终指引着方向。她不仅是第一位用户，更是最严苛的体验官，用耐心和真诚推动系统走向成熟。",
                React.createElement("br", null),
                React.createElement("br", null),
                "店数智的每一行代码里，都藏着她的支持；每一个功能背后，都有她的智慧闪光。资金的支持让开发成为可能，情感的陪伴让坚持有了意义，灵感的碰撞让产品有了灵魂，时间的投入让信任有了厚度。",
                React.createElement("br", null),
                React.createElement("br", null),
                "没有刘思琦，就没有店数智。这不是一句客套的感谢，而是一个开发者在键盘与屏幕之间，最真挚、最深沉的告白。",
                React.createElement("span", { style: { fontSize: "18px", fontWeight: 700, color: "#e8d5a3" } }, "」"),
              ),
              React.createElement("div", { style: { marginTop: "18px", paddingTop: "14px", borderTop: "1px solid #2a3a4f", display: "flex", justifyContent: "space-between", alignItems: "center" } },
                React.createElement("div", { style: { fontSize: "11px", color: "#5a6a7f", letterSpacing: "1px" } }, "此系统因你而生，为你而优化"),
                React.createElement("div", { style: { fontSize: "12px", color: "#c9a96e", fontStyle: "italic", fontWeight: 500, letterSpacing: "0.5px" } }, "—— 开发者 陈泽平 敬上"),
              ),
            ),
          ),
        ),
      ...
      : React.createElement("div", { className: "settings-section" },
          ...
          accounts.length === 0
            ...
            : React.createElement("div", { className: "data-table-container" },
                React.createElement("table", { className: "table settings-accounts-table" },
                  React.createElement("thead", null,
                    React.createElement("tr", null,
                      React.createElement("th", null, "用户名"),
                      React.createElement("th", null, "姓名"),
                      React.createElement("th", null, "邮箱"),
                      React.createElement("th", { style: { width: 90 } }, "角色"),
                      React.createElement("th", { style: { width: 70 } }, "状态"),
                      React.createElement("th", { style: { width: 120 } }, "操作"),
                    ),
                  ),
                  React.createElement("tbody", null,
                    accounts.map((acc) => React.createElement("tr", { key: acc.id },
                      React.createElement("td", null, React.createElement("span", { className: "account-username" }, acc.username)),
                      React.createElement("td", null, acc.name || "-"),
                      React.createElement("td", null, React.createElement("span", { className: "account-email" }, acc.email || "-")),
                      ...
                      React.createElement("td", null,
                        React.createElement("div", { className: "action-btn-group account-actions" },
                          React.createElement("button", { className: "action-btn action-edit icon-only", onClick: () => startEditAccount(acc), title: "修改" }, React.createElement(Icons.Pencil, { size: 14 })),
                          React.createElement("button", { className: `action-btn icon-only ${acc.status === "active" ? "action-delete" : "action-view"}`, onClick: () => toggleAccountStatus(acc), title: acc.status === "active" ? "禁用" : "启用" }, acc.status === "active" ? React.createElement(Icons.Pause, { size: 14 }) : React.createElement(Icons.Play, { size: 14 })),
                          React.createElement("button", { className: "action-btn action-delete icon-only", onClick: () => handleDeleteAccount(acc), title: "删除" }, React.createElement(Icons.Trash, { size: 14 })),
                        ),
                      ),
                    )),
                  ),
