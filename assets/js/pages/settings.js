  ...
  const renderAbout = () => {
    ...
    return React.createElement(
      ...
      React.createElement("div", { className: "settings-section" },
        ...
        React.createElement("div", { className: "settings-section-desc" }, "本系统的成长离不开每一位支持者的付出"),
        React.createElement("div", { style: { marginTop: "16px", background: "linear-gradient(135deg, var(--color-primary-50) 0%, var(--color-accent-50) 100%)", borderRadius: "var(--radius-lg)", padding: "20px", border: "1px solid var(--color-primary-100)" } },
          React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "16px", marginBottom: "12px" } },
            React.createElement("div", { style: { width: "56px", height: "56px", background: "var(--color-primary)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "24px", fontWeight: 700, color: "white" } }, "LSQ"),
            React.createElement("div", { style: { flex: 1 } },
              React.createElement("div", { style: { fontSize: "18px", fontWeight: 700, color: "var(--color-text-primary)", marginBottom: "4px" } }, "刘思琦"),
              React.createElement("div", { style: { fontSize: "13px", color: "var(--color-text-secondary)" } }, "系统核心支持者"),
            ),
          ),
          React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px", marginTop: "16px" } },
            React.createElement("div", { style: { background: "rgba(255,255,255,0.8)", borderRadius: "var(--radius-md)", padding: "12px", textAlign: "center" } },
              React.createElement("div", { style: { fontSize: "20px", marginBottom: "4px" } }, "💰"),
              React.createElement("div", { style: { fontSize: "12px", color: "var(--color-text-secondary)" } }, "资金支持"),
              React.createElement("div", { style: { fontSize: "11px", color: "var(--color-text-tertiary)", marginTop: "2px" } }, "提供开发资源"),
            ),
            React.createElement("div", { style: { background: "rgba(255,255,255,0.8)", borderRadius: "var(--radius-md)", padding: "12px", textAlign: "center" } },
              React.createElement("div", { style: { fontSize: "20px", marginBottom: "4px" } }, "💪"),
              React.createElement("div", { style: { fontSize: "12px", color: "var(--color-text-secondary)" } }, "情感支持"),
              React.createElement("div", { style: { fontSize: "11px", color: "var(--color-text-tertiary)", marginTop: "2px" } }, "持续鼓励陪伴"),
            ),
            React.createElement("div", { style: { background: "rgba(255,255,255,0.8)", borderRadius: "var(--radius-md)", padding: "12px", textAlign: "center" } },
              React.createElement("div", { style: { fontSize: "20px", marginBottom: "4px" } }, "✨"),
              React.createElement("div", { style: { fontSize: "12px", color: "var(--color-text-secondary)" } }, "灵感支持"),
              React.createElement("div", { style: { fontSize: "11px", color: "var(--color-text-tertiary)", marginTop: "2px" } }, "提供创意方向"),
            ),
          ),
          React.createElement("div", { style: { marginTop: "16px", padding: "12px", background: "rgba(255,255,255,0.6)", borderRadius: "var(--radius-md)", fontSize: "13px", lineHeight: "1.6", color: "var(--color-text-primary)" } },
            "🎯 ",
            "刘思琦女士是本系统最重要的支持者与合作伙伴。在系统的整个开发过程中，她不仅提供了关键的资金支持，确保项目能够顺利推进；更在无数个艰难时刻给予了温暖的情感鼓励，让开发者能够保持信心与动力。",
            React.createElement("br", null),
            "🎯 ",
            "她的智慧与创意更是系统不断进化的源泉——许多核心功能的灵感都来自于她的独到见解。没有刘思琦的全方位支持，就没有今天的店数智平台。",
          ),
        ),
      ),
      React.createElement("div", { className: "settings-section" },
