    ...
    return React.createElement(
      ...
      React.createElement("div", { className: "settings-section" },
        React.createElement("div", { className: "about-info" },
          ...
          React.createElement("div", { className: "about-version" }, `版本 ${Store.getVersion()}`),
      ...
      React.createElement("div", { className: "settings-section" },
        React.createElement("div", { className: "settings-section-title" }, "收款码"),
        React.createElement("div", { className: "settings-section-desc" }, "上传收款码图片，方便用户扫码支付"),
        React.createElement("div", { style: { marginTop: "16px" } },
          React.createElement("div", { className: "payment-qr-container" },
            Store.getPaymentQR() ? React.createElement("img", { src: Store.getPaymentQR(), className: "payment-qr-img", alt: "收款码" }) : React.createElement("div", { className: "payment-qr-placeholder" },
              React.createElement(Icons.QrCode, { style: { width: 48, height: 48, color: "var(--color-text-tertiary)" } }),
              React.createElement("div", { style: { marginTop: "8px", fontSize: "13px", color: "var(--color-text-tertiary)" } }, "暂无收款码"),
            ),
          ),
          React.createElement("div", { style: { marginTop: "12px", display: "flex", gap: "10px" } },
            React.createElement("input", { type: "file", accept: "image/*", className: "qr-upload-input", onChange: (e) => { const file = e.target.files?.[0]; if (file) { const reader = new FileReader(); reader.onload = (ev) => { Store.setPaymentQR(ev.target?.result); addToast("success", "上传成功", "收款码已更新"); }; reader.readAsDataURL(file); } } }),
            React.createElement(Button, { type: "default", size: "sm", onClick: () => { Store.setPaymentQR(null); addToast("success", "已清除", "收款码已清除"); } }, React.createElement(Icons.Trash, null), " 清除"),
          ),
        ),
      ),
      React.createElement("div", { className: "settings-section" },
