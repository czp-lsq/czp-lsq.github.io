      ...
      React.createElement("div", { className: "settings-section" },
        ...
        React.createElement("div", { className: "about-grid" },
          ...
          React.createElement("div", { className: "about-item" },
            ...
            React.createElement("div", { className: "about-item-value" }, `${window.AppVersion || "czp-1.12.0"} (数据版本: ${Store.getVersion()})`),
          ),
          React.createElement("div", { className: "about-item" },
          ...
          React.createElement("div", { className: "about-item" },
            React.createElement("div", { className: "about-item-label" }, "付费联系"),
            React.createElement("div", { className: "about-item-value" }, React.createElement("span", { style: { color: "var(--color-success)", fontWeight: 600 } }, "czp.31")),
          ),
        ),
      ),
