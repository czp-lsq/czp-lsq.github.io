      ...
      React.createElement("div", { className: "settings-section" },
        ...
        React.createElement("div", { style: { marginTop: "20px", background: "linear-gradient(135deg, var(--color-primary) 0%, var(--color-accent) 50%, var(--color-success) 100%)", borderRadius: "var(--radius-xl)", padding: "32px", boxShadow: "0 12px 40px rgba(var(--color-primary-rgb), 0.25)", position: "relative", overflow: "hidden" } },
          ...
          React.createElement("div", { style: { position: "relative", zIndex: 1 } },
            ...
            React.createElement("div", { style: { marginTop: "24px", padding: "20px", background: "rgba(255,255,255,0.1)", borderRadius: "var(--radius-lg)", fontSize: "14px", lineHeight: "2", color: "white", borderLeft: "4px solid rgba(255,255,255,0.5)", backdropFilter: "blur(4px)" } },
              React.createElement("span", { style: { fontSize: "20px", fontWeight: 700 } }, "「"),
              "刘思琦女士是店数智平台赖以诞生的基石。她以远见卓识提供了关键的资金支持，让技术开发无后顾之忧；以温柔坚韧的情感力量，在每一个困顿的时刻成为开发者最坚实的后盾。",
              React.createElement("br", null),
              React.createElement("br", null),
              "她的智慧之光穿透了无数个深夜的代码迷宫，许多核心功能的灵感都源于她敏锐的洞察与独到的见解。从需求构想到产品落地，她始终以第一用户的身份参与打磨，让系统不仅可用，更值得信赖。",
              React.createElement("br", null),
              React.createElement("br", null),
              "没有刘思琦的全方位支持——资金的、情感的、智慧的、时间的——就不会有今天的店数智。这不是一句客套，而是一个开发者最真诚的告白。",
              React.createElement("span", { style: { fontSize: "20px", fontWeight: 700 } }, "」"),
              React.createElement("div", { style: { marginTop: "12px", textAlign: "right", fontSize: "12px", color: "rgba(255,255,255,0.6)", fontStyle: "italic" } },
                "—— 开发者 陈泽平",
              ),
            ),
          ),
