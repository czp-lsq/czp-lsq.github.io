...
const SettingsPage = ({ state, onNavigate, currentTheme, colorTheme, onChangeTheme, onChangeColorTheme, currentUser, onLogout }) => {
  ...
  const renderAppearance = () => React.createElement(
    ...
    React.createElement("div", { className: "settings-section" },
      ...
      React.createElement("div", { className: "theme-selector theme-color-selector", style: { marginTop: "20px" } },
    ...
    React.createElement("div", { className: "settings-section" },
      ...
      React.createElement("div", { className: "theme-mode-toggle", style: { marginTop: "20px" } },
  ...
  const renderAbout = () => {
    ...
    return React.createElement(
      ...
      React.createElement("div", { className: "settings-section" },
        ...
        React.createElement("div", { style: { marginTop: "20px", background: "linear-gradient(135deg, var(--color-primary) 0%, var(--color-accent) 50%, var(--color-success) 100%)", borderRadius: "var(--radius-xl)", padding: "32px", boxShadow: "0 12px 40px rgba(var(--color-primary-rgb), 0.25)", position: "relative", overflow: "hidden" } },
          React.createElement("div", { style: { position: "absolute", top: 0, right: 0, width: "200px", height: "200px", background: "rgba(255,255,255,0.08)", borderRadius: "50%", transform: "translate(50%, -50%)" } }),
          React.createElement("div", { style: { position: "absolute", bottom: 0, left: 0, width: "150px", height: "150px", background: "rgba(255,255,255,0.05)", borderRadius: "50%", transform: "translate(-30%, 30%)" } }),
          React.createElement("div", { style: { position: "relative", zIndex: 1 } },
            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "24px", marginBottom: "24px" } },
              React.createElement("div", { style: { width: "80px", height: "80px", background: "rgba(255,255,255,0.2)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "36px", fontWeight: 800, color: "white", boxShadow: "0 6px 20px rgba(0,0,0,0.2)", flexShrink: 0, border: "3px solid rgba(255,255,255,0.3)" } }, "LSQ"),
              React.createElement("div", { style: { flex: 1 } },
                React.createElement("div", { style: { fontSize: "26px", fontWeight: 800, color: "white", marginBottom: "6px", display: "flex", alignItems: "center", gap: "12px" } }, 
                  "刘思琦", 
                  React.createElement("span", { style: { fontSize: "12px", padding: "3px 12px", background: "rgba(255,255,255,0.25)", color: "white", borderRadius: "var(--radius-full)", fontWeight: 600, backdropFilter: "blur(4px)" } }, "核心支持者 · 灵魂伙伴"),
                ),
                React.createElement("div", { style: { fontSize: "14px", color: "rgba(255,255,255,0.85)", fontWeight: 500 } }, "资金赞助 · 情感后盾 · 灵感缪斯 · 产品体验官"),
              ),
            ),
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "12px", marginTop: "24px" } },
              React.createElement("div", { style: { background: "rgba(255,255,255,0.15)", borderRadius: "var(--radius-lg)", padding: "18px 12px", textAlign: "center", transition: "all 0.3s", hover: { background: "rgba(255,255,255,0.2)", transform: "translateY(-2px)" }, backdropFilter: "blur(8px)" } },
                React.createElement("div", { style: { fontSize: "28px", marginBottom: "8px" } }, "💰"),
                React.createElement("div", { style: { fontSize: "13px", fontWeight: 700, color: "white" } }, "资金赞助"),
                React.createElement("div", { style: { fontSize: "11px", color: "rgba(255,255,255,0.7)", marginTop: "4px", lineHeight: "1.5" } }, "保障开发资源持续投入"),
              ),
              React.createElement("div", { style: { background: "rgba(255,255,255,0.15)", borderRadius: "var(--radius-lg)", padding: "18px 12px", textAlign: "center", transition: "all 0.3s", hover: { background: "rgba(255,255,255,0.2)", transform: "translateY(-2px)" }, backdropFilter: "blur(8px)" } },
                React.createElement("div", { style: { fontSize: "28px", marginBottom: "8px" } }, "💝"),
                React.createElement("div", { style: { fontSize: "13px", fontWeight: 700, color: "white" } }, "情感后盾"),
                React.createElement("div", { style: { fontSize: "11px", color: "rgba(255,255,255,0.7)", marginTop: "4px", lineHeight: "1.5" } }, "在低谷时给予温暖力量"),
              ),
              React.createElement("div", { style: { background: "rgba(255,255,255,0.15)", borderRadius: "var(--radius-lg)", padding: "18px 12px", textAlign: "center", transition: "all 0.3s", hover: { background: "rgba(255,255,255,0.2)", transform: "translateY(-2px)" }, backdropFilter: "blur(8px)" } },
                React.createElement("div", { style: { fontSize: "28px", marginBottom: "8px" } }, "✨"),
                React.createElement("div", { style: { fontSize: "13px", fontWeight: 700, color: "white" } }, "灵感缪斯"),
                React.createElement("div", { style: { fontSize: "11px", color: "rgba(255,255,255,0.7)", marginTop: "4px", lineHeight: "1.5" } }, "启发核心功能设计方向"),
              ),
              React.createElement("div", { style: { background: "rgba(255,255,255,0.15)", borderRadius: "var(--radius-lg)", padding: "18px 12px", textAlign: "center", transition: "all 0.3s", hover: { background: "rgba(255,255,255,0.2)", transform: "translateY(-2px)" }, backdropFilter: "blur(8px)" } },
                React.createElement("div", { style: { fontSize: "28px", marginBottom: "8px" } }, "🎯"),
                React.createElement("div", { style: { fontSize: "13px", fontWeight: 700, color: "white" } }, "体验官"),
                React.createElement("div", { style: { fontSize: "11px", color: "rgba(255,255,255,0.7)", marginTop: "4px", lineHeight: "1.5" } }, "以用户视角驱动迭代"),
              ),
            ),
            React.createElement("div", { style: { marginTop: "24px", padding: "24px", background: "rgba(255,255,255,0.1)", borderRadius: "var(--radius-lg)", color: "white", borderLeft: "4px solid rgba(255,255,255,0.5)", backdropFilter: "blur(4px)" } },
              React.createElement("div", { style: { fontSize: "13px", fontWeight: 700, color: "rgba(255,255,255,0.7)", marginBottom: "12px", letterSpacing: "2px", textTransform: "uppercase" } }, "致 谢 词"),
              React.createElement("div", { style: { fontSize: "15px", lineHeight: "2.2", fontWeight: 500 } },
                React.createElement("span", { style: { fontSize: "22px", fontWeight: 700, color: "rgba(255,255,255,0.9)" } }, "「"),
              ...
              React.createElement("div", { style: { marginTop: "16px", paddingTop: "12px", borderTop: "1px solid rgba(255,255,255,0.15)", display: "flex", justifyContent: "space-between", alignItems: "center" } },
                React.createElement("div", { style: { fontSize: "12px", color: "rgba(255,255,255,0.5)" } }, "此系统因你而生，为你而优化"),
                React.createElement("div", { style: { fontSize: "13px", color: "rgba(255,255,255,0.8)", fontStyle: "italic", fontWeight: 600 } }, "—— 开发者 陈泽平 敬上"),
              ),
            ),
          ),
        ),
