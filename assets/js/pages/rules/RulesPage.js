window.RulesPage = function({ state, currentPlatform, onNavigate }) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      "div",
      { className: "rules-page__header" },
      /*#__PURE__*/ React.createElement("div", { className: "rules-page__header-left" },
        /*#__PURE__*/ React.createElement("button", {
          className: "rules-page__toggle-btn",
          onClick: () => setLeftPanelCollapsed(!leftPanelCollapsed),
        },
          /*#__PURE__*/ React.createElement(Icons.ChevronLeft, { size: 18 }),
        ),
        /*#__PURE__*/ React.createElement("h1", { className: "rules-page__title" },
          /*#__PURE__*/ React.createElement(Icons.FileRule, { size: 20 }),
          " 计算规则",
        ),
      ),
      /*#__PURE__*/ React.createElement("div", { className: "rules-page__header-center" },
        /*#__PURE__*/ React.createElement("div", { className: "rules-page__progress" },
          /*#__PURE__*/ React.createElement("div", { className: "rules-page__progress-bar" },
            /*#__PURE__*/ React.createElement("div", { className: "rules-page__progress-fill", style: { width: `${completionRate}%` } }),
          ),
          /*#__PURE__*/ React.createElement("span", { className: "rules-page__progress-text" }, `${completedCount}/${fields.length}`),
        ),
      ),
      /*#__PURE__*/ React.createElement("div", { className: "rules-page__header-right" },
        /*#__PURE__*/ React.createElement("button", {
    ...
    /*#__PURE__*/ React.createElement(
      "div",
      { className: "rules-page__body" },
      /*#__PURE__*/ React.createElement("div", { className: `rules-page__left-panel ${leftPanelCollapsed ? 'rules-page__left-panel--collapsed' : ''}` },
        /*#__PURE__*/ React.createElement("div", { className: "rules-page__left-inner" },
      ...
      /*#__PURE__*/ React.createElement("div", { className: "rules-page__main-panel" },
        activeField ? /*#__PURE__*/ React.createElement(React.Fragment, null,
          /*#__PURE__*/ React.createElement("div", { className: "rules-page__field-header" },
            /*#__PURE__*/ React.createElement("div", { className: "rules-page__field-header-left" },
              /*#__PURE__*/ React.createElement("span", { className: "rules-page__field-icon" }, getSemanticIcon(activeField.semanticType, activeField.type)),
              /*#__PURE__*/ React.createElement("div", { className: "rules-page__field-info" },
                /*#__PURE__*/ React.createElement("span", { className: "rules-page__field-name" }, activeField.name),
                /*#__PURE__*/ React.createElement("span", { className: "rules-page__field-type" }, activeField.semanticType || activeField.type),
              ),
            ),
            /*#__PURE__*/ React.createElement("div", { className: "rules-page__field-header-right" },
              /*#__PURE__*/ React.createElement("button", {
          ...
          /*#__PURE__*/ React.createElement("div", { className: "rules-page__steps-container" },
            currentRule?.steps?.length > 0 ? currentRule.steps.map((step, idx) => {
              const typeInfo = getStepTypeInfo(step.type);
              const isExpanded = expandedStep === step.id;
              return /*#__PURE__*/ React.createElement(
                "div",
                { key: step.id, className: "rules-page__step-card" },
                /*#__PURE__*/ React.createElement("div", {
                  className: "rules-page__step-header",
                  onClick: () => setExpandedStep(isExpanded ? null : step.id),
                },
                  /*#__PURE__*/ React.createElement("span", { className: "rules-page__step-number" }, idx + 1),
                  /*#__PURE__*/ React.createElement("span", { className: "rules-page__step-icon", style: { color: typeInfo.color } }, typeInfo.icon),
                  /*#__PURE__*/ React.createElement("span", { className: "rules-page__step-name" }, typeInfo.name),
                  /*#__PURE__*/ React.createElement("span", { className: "rules-page__step-summary" }, summarizeStep(step)),
                  /*#__PURE__*/ React.createElement("div", { className: "rules-page__step-actions" },
                    idx > 0 && /*#__PURE__*/ React.createElement("button", {
                      className: "rules-page__step-action",
                    ...
                    /*#__PURE__*/ React.createElement("button", {
                      className: "rules-page__step-action rules-page__step-action--danger",
                      onClick: (e) => { e.stopPropagation(); deleteStep(step.id); },
                    },
                      /*#__PURE__*/ React.createElement(Icons.Trash2, { size: 14 }),
                    ),
                  ),
                  /*#__PURE__*/ React.createElement("span", { className: `rules-page__step-expand ${isExpanded ? 'rules-page__step-expand--rotated' : ''}` },
                    /*#__PURE__*/ React.createElement(Icons.ChevronDown, { size: 16 }),
                  ),
                ),
                isExpanded && /*#__PURE__*/ React.createElement("div", { className: "rules-page__step-config" },
                  renderStepConfig(step, activeField),
                ),
              );
            }) : /*#__PURE__*/ React.createElement("div", { className: "rules-page__empty-state" },
      ...
      /*#__PURE__*/ React.createElement("div", { className: "rules-page__right-panel" },
        /*#__PURE__*/ React.createElement("div", { className: "rules-page__right-header" },
          /*#__PURE__*/ React.createElement("span", { className: "rules-page__right-title" },
            /*#__PURE__*/ React.createElement(Icons.Eye, { size: 16 }),
            " 实时预览",
          ),
          /*#__PURE__*/ React.createElement("div", { className: "rules-page__right-toggle" },
            /*#__PURE__*/ React.createElement("label", { className: "rules-page__toggle-switch" },
              /*#__PURE__*/ React.createElement("input", {
                type: "checkbox",
                checked: debugMode,
                onChange: (e) => setDebugMode(e.target.checked),
              }),
              /*#__PURE__*/ React.createElement("span", { className: "rules-page__toggle-slider" }),
            ),
            /*#__PURE__*/ React.createElement("span", { className: "rules-page__toggle-label" }, "调试模式"),
          ),
        ),
        debugMode && activeField && currentRule && currentRule.steps.length > 0 ? /*#__PURE__*/ React.createElement(React.Fragment, null,
          previewResult?.error ? /*#__PURE__*/ React.createElement("div", { className: "rules-page__preview-error" },
            /*#__PURE__*/ React.createElement(Icons.AlertTriangle, { size: 24 }),
            /*#__PURE__*/ React.createElement("span", null, previewResult.error),
          ) : /*#__PURE__*/ React.createElement("div", { className: "rules-page__preview-content" },
        ...
        ) : /*#__PURE__*/ React.createElement("div", { className: "rules-page__preview-empty" },
    ...
    showCopyModal && /*#__PURE__*/ React.createElement(Modal, {
      ...
      /*#__PURE__*/ React.createElement("div", { className: "copy-rule-form" },
        ...
        copySourceFieldId && /*#__PURE__*/ React.createElement("div", { className: "rules-page__copy-preview" },
          /*#__PURE__*/ React.createElement("div", { className: "rules-page__copy-preview-title" }, "源规则预览："),
          (savedRules[copySourceFieldId]?.steps || []).map((s, i) => {
            const info = getStepTypeInfo(s.type);
            return /*#__PURE__*/ React.createElement("div", { key: s.id, className: "rules-page__copy-step" },
              /*#__PURE__*/ React.createElement("span", { style: { color: info.color } }, i + 1, ". ", info.name),
              /*#__PURE__*/ React.createElement("span", { className: "rules-page__copy-step-summary" }, summarizeStep(s)),
            );
          }),
        ),
      ),
    ...
    showShortcuts && /*#__PURE__*/ React.createElement(Modal, {
      ...
      /*#__PURE__*/ React.createElement("div", { className: "rules-page__shortcuts-panel" },
        /*#__PURE__*/ React.createElement("div", { className: "rules-page__shortcuts-title" }, "常用快捷键"),
        /*#__PURE__*/ React.createElement("div", { className: "rules-page__shortcuts-list" },
          /*#__PURE__*/ React.createElement("div", { className: "rules-page__shortcut-item" },
            /*#__PURE__*/ React.createElement("span", { className: "rules-page__shortcut-key" }, "Ctrl + S"),
            /*#__PURE__*/ React.createElement("span", null, "保存当前字段规则"),
          ),
          /*#__PURE__*/ React.createElement("div", { className: "rules-page__shortcut-item" },
            /*#__PURE__*/ React.createElement("span", { className: "rules-page__shortcut-key" }, "↑"),
